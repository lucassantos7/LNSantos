...
import Buyer from 'react-native-vector-icons/FontAwesome5';
...
import SideBar from '../../components/CustomDrawer.js';
  ...
  export default class HomeScreen extends Component {
    ...
    Imovel = (navigation) => {
      this.props.navigation.navigate('Imovel')
    }
    ...
    async componentDidMount()  {
      const token = await AsyncStorage.getItem('@ImvUser:accessToken')
      const user = await AsyncStorage.getItem('@ImvUser:usuario')
      ...
      return (
          <SafeAreaView style={styles.container}>
            ...
            <View style={styles.headerContainer}>
              ...
              <TouchableOpacity style={styles.buttons} onPress={this.Buy}>
                  <Buyer name='dollar-sign' size={30} color='#486ff9'/>
                  <Text style={styles.buttonText}>Comprar</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.buttons} onPress={this.Rent}>
                  <Icon name='home-city'size={30} color='#486ff9'/>
                  <Text style={styles.buttonText}>Alugar</Text>
              </TouchableOpacity>
              </View>
              <View style={styles.recents}>
                  <Icon style={styles.recentsIcon} name='clock-outline' size={20} color='#486ff9'/>
                  <Text style={styles.recentsText}>Recentes</Text>
              </View>
